...
function Signup() {
  ...
  <div className="bg-white h-full rounded-xl grid md:grid-cols-2 p-2">
      ...
      <div className="bg-50 p-20  flex justify-center">
          <div className="bg-pink-200 min-h-full     rounded-lg p-2 w-[400px]">
              ...
              <button className=" mx-12 mt-8 bg-pink-400   rounded-full h-10 min-w-72">Sign Up</button>
              ...
              <h1 className="mx-16 mt-2 text-sm font-light text-center"> Already have an Account </h1>
           
              <button onClick={()=>navigate('/')} className="   mx-40 mt-2 mb-4 text-red-600     ">Login</button>
